...
salario         NUMBER(8,2) CONSTRAINT min_emp_salario CHECK (salario > 0),
...
CONSTRAINT pk_id_empregado_data_inicio PRIMARY KEY(id_empregado, data_inicio),
CONSTRAINT fk_id_empregado_hist FOREIGN KEY(id_empregado)
    REFERENCES tb_empregado(id_empregado),
CONSTRAINT pk_id_funcao_hist FOREIGN KEY(id_funcao)
    REFERENCES tb_funcao(id_funcao),
CONSTRAINT fk_id_departamento_hist FOREIGN KEY(id_departamento)
    REFERENCES tb_departamento(id_departamento)
);
...
INSERT INTO tb_funcao 
VALUES ('PR_REP', 'Representante Relações Pública', 4500, 10500);
SELECT *
FROM tb_funcao;
